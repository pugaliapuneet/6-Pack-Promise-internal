 ...
 * @param path {String | String[]}
  @return {function(*=): }
 */
export const safeGetOr = <TObject extends object, TDefault>(defaultValue: TDefault, path: string) => {
  /**
    @param object {}
   *
    @return {defaultValue | }
...
export const safeGetCollection = <TObject extends object, TDefault>(path: string) => (object: TObject): TDefault[] =>
